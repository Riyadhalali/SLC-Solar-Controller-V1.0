...
void SetHourTimer_1_Start();
void SetMinutesTimer_1_Start();
void SetSecondsTimer_1();           // not used
void SetHoursTimer_1_Stop();
void SetMinutesTimer_1_Stop();
void SetSecondsTimer_2();    // not uses
void SetHoursTimer_2_Start();
void SetMinutesTimer_2_Start();
void SetHoursTimer_2_Stop();
void SetMinutesTimer_2_Stop();
void SetHoursTimer_3_Start();
void SetMinutesTimer_3_Start();
void SetHoursTimer_3_Stop();
void SetMinutesTimer_3_Stop();
...
SetHourTimer_1_Start();  //program   1
SetMinutesTimer_1_Start();  // program 2
SetHoursTimer_1_Stop();      // program 3
SetMinutesTimer_1_Stop();    // program 4
SetHoursTimer_2_Start();      //program 5
SetMinutesTimer_2_Start();     // program 6
SetHoursTimer_2_Stop();
SetMinutesTimer_2_Stop();
//SetHoursTimer_3_Start();
SetMinutesTimer_3_Start();
//SetHoursTimer_3_Stop();
//SetMinutesTimer_3_Stop();     // program 9
...
//--------------------------------Set Minutes Start Timer 2---------------------
void SetMinutesTimer_2_Start()
{
LCD_Clear(1,1,16);
LCD_OUT(1,1,"T2 On:[H] [6]");
Delay_ms(1000);
LCD_Out(2,1,"Entering Minutes:");
Delay_ms(500);
LCD_Clear(2,1,16);
...
//----------------------------Set timer 2 Hours Stop----------------------------
void SetHoursTimer_2_Stop()
{
LCD_Clear(1,1,16);
LCD_OUT(1,1,"T2 Off:[H] [7]");
Delay_ms(1000);
LCD_Out(2,1,"Entering Hours:");
Delay_ms(500);
LCD_Clear(2,1,16);
...
//-----------------------------Minutes Timer 2 stop-----------------------------
void SetMinutesTimer_2_Stop()
{
LCD_Clear(1,1,16);
LCD_OUT(1,1,"T2 Off:[M] [8]");
Delay_ms(1000);
LCD_Out(2,1,"Entering Minutes:");
Delay_ms(500);
LCD_Clear(2,1,16);
...
//--------------------------Set Minutes Timer 3 Start---------------------------
void SetMinutesTimer_3_Start()
{
LCD_Clear(1,1,16);
LCD_OUT(1,1,"T3 On: [10]");
LCD_Clear(2,1,16);
while(Set==1)
{
ByteToStr(hours_lcd_timer3_start,txt);
...
//--------------------------Set Hours Stop Timer3-------------------------------
void SetHoursTimer_3_Stop()
{
LCD_Clear(1,1,16);
LCD_OUT(1,1,"T3 Off:[H][11]");
Delay_ms(1000);
LCD_Out(2,1,"Entering Hours");
Delay_ms(500);
LCD_Clear(2,1,16);
...
//--------------------------------Timer 3 Minutes Stop--------------------------
void SetMinutesTimer_3_Stop()
{
LCD_Clear(1,1,16);
LCD_OUT(1,1,"T3 Off:[M] [12]");
Delay_ms(1000);
LCD_Out(2,1,"Entering Minutes");
Delay_ms(500);
LCD_Clear(2,1,16);
